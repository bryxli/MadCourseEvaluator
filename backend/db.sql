...
--
-- Host: 127.0.0.1    Database: madcourseevaluator
-- ------------------------------------------------------
...
CREATE TABLE `courses` (
  ...
  `cSubject` varchar(45) NOT NULL,
  `cCode` varchar(25) NOT NULL,
  `cCredits` varchar(20) NOT NULL,
...
CREATE TABLE `professors` (
  ...
  `pFName` varchar(75) NOT NULL,
  `pLName` varchar(45) NOT NULL,
  `pData` varchar(200) NOT NULL,
  PRIMARY KEY (`pUID`)
...
CREATE TABLE `rc` (
  ...
  `comBody` varchar(1000) NOT NULL,
  `comLink` varchar(100) NOT NULL,
  `comVotes` int NOT NULL,
  `cUID` int NOT NULL,
  PRIMARY KEY (`comID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-10-25 13:38:48
