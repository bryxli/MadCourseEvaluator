...
const Instructor = () => {
  ...
  return (
    <>
      ...
      <table className="professor-info" align="center">

        {/* Professor Name */}
        <tr style={{ textAlign: "center" }} >
          <td><h1 style={{ fontSize: "xxx-large" }}>{professor.name}</h1></td>
        </tr>
        ...
        <tr>
          <td style={{ textAlign: "center" }}>
            <div style={{ display: "flex", justifyContent: "center" }}>
              <h5 className="bold-heading-style">{"RateMyProfessor Rating (" + professor.RMPTotalRatings + " total ratings)"}</h5>
              <h5 className="heading-style">{"  : " + professor.RMPRating + "/5"}</h5>
            </div>
          </td>
        </tr>
        ...
        <tr>
          <td style={{ textAlign: "center" }}>
            <div style={{ display: "flex", justifyContent: "center" }}>
              <h5 className="bold-heading-style">{"RateMyProfessor Rating Class"}</h5>
              <h5 className="heading-style"> {"  : " + professor.RMPRatingClass} </h5>
            </div>
          </td>
        </tr>
      </table>
      ...
      {courses.length > 0 && (
        ...
        <table className="course-info" align="center">
          <Col className="d-flex justify-content-center">
            <Row className="course-list">
              {courses.map((course) => ( // map the courses array to a new array of rows
                <p
                  className="course-list-item"  // set the class of the row to course-list-item
                  key={course.id}               // set the key as the course id
                  onClick={() => {              // set the onClick function to navigate to the course page for the course at the course id
                    navigate({
                      pathname: "/course",
